#
#  Be sure to run `pod spec lint PJPopViewManager.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/piaojin/PopViewManager.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "PJPopViewManager", "PJPopViewManager/**/*.swift"
